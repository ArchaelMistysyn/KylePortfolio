...
<body>
	...
	<div id="central" class="hidePad">
		<div id="sticky1">
			<H2>CASSAVA LATIN BAND</h2>
			<p>Welcome to Cassava! We offer a plethora of information, services, and content that can be found here including, but not limited to, 
			multiple workshops, public events, merchendise and music samples. For further information beyond what is listed on our website please
			send us a message either by email or from the contact page.
		</div>
		<?php
		if(isset($_SESSION['login_user'])){
		?>
